#!/usr/bin/env python3
"""
Convert Obsidian Excalidraw embeds to HTML object tags for MkDocs.
Uses object tags for better SVG compatibility.
"""
...
# SVG viewBox of the full diagram (from the SVG file)
FULL_SVG_VIEWBOX = {
    'x': 0,
    'y': 0,
    'width': 9888.303446600697,
    'height': 5122.225109210625
}

def convert_excalidraw_links(content):
    """
    Convert Obsidian Excalidraw embeds to HTML object tags.

    Pattern: ![[episodes/01-portfolio-no-code/diagrams/all-diagrams.excalidraw.md#^frame=FRAME_ID]]
    To: <object> tag with SVG and fragment identifier
    """
    ...
    def replace_embed(match):
        ...
        # Method 1: Use object tag with SVG fragment
        # This allows the browser to handle the SVG natively
        svg_embed = f'''<div style="width: 100%; max-width: 1200px; margin: 2rem auto;">
<div style="width: 100%; padding-bottom: {aspect_ratio * 100:.1f}%; position: relative; border: 1px solid #e1e4e8; border-radius: 8px; overflow: hidden; background: white;">
<object type="image/svg+xml"
        data="../diagrams/all-diagrams.excalidraw.light.svg#svgView(viewBox({view_x},{view_y},{view_width},{view_height}))"
...
if __name__ == "__main__":
    print("Converting Obsidian Excalidraw embeds to HTML object tags...")
